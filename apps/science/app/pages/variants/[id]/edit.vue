<template>
  <div>
    <div class="flex items-center gap-3 p-3">
      ...
      <h1 class="flex-1 text-xl font-bold">Edit Variant</h1>
...
const createVariantMutation = graphql(`
  mutation CreateVariantEdit($input: CreateVariantInput!) {
...
const updateVariantMutation = graphql(`
  mutation UpdateVariantEdit($input: UpdateVariantInput!) {
