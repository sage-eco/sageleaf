<template>
  <div>
    <div class="flex items-center gap-3 p-3">
      ...
      <h1 class="flex-1 text-xl font-bold">New Component</h1>
    ...
    <ModelForm
      ...
      hide-submit
      @saved="(id) => navigateTo(`/components/${id}`)"
    />
  </div>
</template>
...
const createComponentMutation = graphql(`
  mutation CreateComponentNew($input: CreateComponentInput!) {
...
const updateComponentMutation = graphql(`
  mutation UpdateComponentNew($input: UpdateComponentInput!) {
